...
class Label extends Container {
    ...
    public function __construct() {
        parent::__construct();
        $this->_sOpeningTag = "label";
        $this->_sClosingTag = "label";
    }

    protected function _getComponentContent() {        
        return $this->_getFieldIsSequenceSpan() . $this->getLabel() . $this->_getFieldIsRequireSpan();    
    }

    protected function _preRender() {

        $this->prependComponentAppend($this->_getFieldTooltipIconSpan());
